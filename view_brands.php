        ...
        <?php
            ...
            while($row= mysqli_fetch_assoc($result)){
                ...
                echo "<tr class='text-center'>
                        <td>$number</td>
                        <td>$brand_title</td>
                        <td><a href='index.php?edit_brands=$brand_id' class='text-light'><i class='fa-solid fa-pen-to-square'></i></a></td>
                        <td><a href='index.php?delete_brands=$brand_id' type='button' class='text-light' data-toggle='modal' data-target='#exampleModal'><i class='fa-solid fa-trash'></i></a></td>
                    </tr>";
            }
        ?>
